...
var PostsComponent = (function () {
    ...
    PostsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._postsService.getPosts().subscribe(function (posts) { return _this.posts = posts; }, function (error) { return console.log(error); }, function () { return _this.postsLoading = false; });
    ...
    PostsComponent.prototype.onSelectUser = function (userId) {
        var _this = this;
        this.postsLoading = true;
        var result;
        if (userId)
        ...
        result.subscribe(function (posts) { return _this.posts = posts; }, function (error) { return console.log(error); }, function () { return _this.postsLoading = false; });
    };
